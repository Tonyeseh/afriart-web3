...
const tooltips = {
  title: "Enter a unique and descriptive title for your artwork",
  description: "Provide details about your artwork, inspiration, and artistic process",
  ...
  upload: "Upload your artwork file. Supports JPG, PNG, MP4. Maximum size: 20MB"
};
